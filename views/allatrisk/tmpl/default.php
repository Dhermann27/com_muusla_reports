...
<link type="text/css"
   ...
   rel="stylesheet" />
<div id="ja-content">
   <div class="componentheading">All At-Risk Campers</div>
   <table class="blog">
      <tr>
         <td valign="top">
            <div>
               <div class="article-content">
                  <table id="muusaApp">
                     ...
                     <tr>
                        <td colspan="4"><h3>Unregistered Preregistered
                              Campers</h3></td>
                     </tr>
                     <?php 
                     $count = 0;
                     foreach ($this->unreg as $camper) {
                        echo "                  <tr>\n";
                     ...
                     <tr>
                        <td colspan="4"><h3>Unassigned Preregistered
                              Campers</h3></td>
                     </tr>
                     <?php 
                     $count = 0;
                     foreach ($this->unass as $camper) {
                        echo "                  <tr>\n";
                        echo "                     <td>$camper->lastname</td>\n";
                        echo "                     <td>$camper->firstname</td>\n";
                        echo "                     <td>($camper->familyname)</td>\n";
                     ...
                     <tr>
                        <td colspan="4"><h3>Lost Campers (Attended Last
                              Year, Not This Year)</h3></td>
                     </tr>
                     <?php 
                     $count = 0;
                     foreach ($this->lost as $camper) {
                        echo "                  <tr>\n";
                        echo "                     <td>$camper->lastname</td>\n";
                        echo "                     <td>$camper->firstname</td>\n";
                        echo "                     <td>($camper->familyname)</td>\n";
